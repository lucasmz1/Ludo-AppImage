...
mv sharun-x86_64 sharun && chmod +x sharun && mv sharun ./Ludo-Linux-x11-x86_64* && cd Ludo-Linux-x11-x86_64* && xvfb-run -a ./sharun l -p -v -e -s -k ./ludo \
	...
	/lib/x86_64-linux-gnu/libGLdispatch.so* \
	/lib/x86_64-linux-gnu/libGLX.so* \
	/lib/x86_64-linux-gnu/libX11.so* \
	/lib/x86_64-linux-gnu/libxcb.so* \
	/lib/x86_64-linux-gnu/libXau.so* \
	/lib/x86_64-linux-gnu/libXdmcp.so* \
